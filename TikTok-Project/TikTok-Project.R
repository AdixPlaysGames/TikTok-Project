...
#Zakryte imiona w celach prywatnosci
...
#Dane
#Tutaj podajemy nasze pobrane dane w formacie JSON
m_data <- fromJSON("user_data.json")
z_data <- fromJSON("user_data.json")
a_data <- fromJSON("user_data.json")
